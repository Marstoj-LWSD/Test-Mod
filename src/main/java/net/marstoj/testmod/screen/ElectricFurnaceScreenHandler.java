...
public class ElectricFurnaceScreenHandler extends ScreenHandler {
    ...
    public ElectricFurnaceScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity,
                                          PropertyDelegate arrayPropertyDelegate) {
        super(ModBlocks.ELECTRIC_FURNACE_SCREEN_HANDLER, syncId);
